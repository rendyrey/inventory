      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('grafik')}}"><i class="fa fa-circle-o"></i>Harga</a></li>
            <li><a href="{{url('grafik/order')}}"><i class="fa fa-circle-o"></i>Order</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Master Data/Belanja</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li><a href="{{url('kalender')}}"><i class="fa fa-calendar"></i> <span>Kalender</span></a></li>
